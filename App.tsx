    ...
    <nav className="sticky top-0 z-50 w-full bg-white/95 dark:bg-dark-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 shadow-sm transition-all">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
           {/* Custom Logo */}
           <img src="public/DeshiSheba.png" className="w-9 h-9 object-contain" alt="DeshiSheba Logo" />
            ...
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <div className="space-y-4">
                    <div className="flex items-center gap-2">
                        {/* Custom Logo */}
                        <img src="public/DeshiSheba.png" className="w-8 h-8 object-contain bg-white rounded-lg p-1" alt="Logo" />
